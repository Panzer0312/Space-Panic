...
int GameController::init() {
	...
	std::vector<Vector2i> playerUp{ Vector2i(4,3)};
...
void GameController::moveObject(Vector2f dir, std::string name, std::string animation)
{
